...
def parse_args():
    ...
    # 配置文件
    parser.add_argument("--config",default="configs/fastbev/exp/paper/fastbev_m5_r50_s512x1408_v250x250x6_c256_d6_f4.py",help="train config file path",)
    
    parser.add_argument('--checkpoint',default="pretrained_models/m5-r50-epoch_20.pth", help='checkpoint file')
    
    parser.add_argument('--out', default="output/1.pkl",  help='output result file in pickle format')
    parser.add_argument(
        '--fuse-conv-bn',
        action='store_true',
